 ...
 * Generated for Laravel 5.5.16 on 2017-10-17.
 *
...
namespace GetStream\StreamLaravel\Facades { 
    ...
    class FeedManager {
        ...
        {
            return \GetStream\StreamLaravel\StreamLaravelManager::getUserFeed($user_id);
        }
         ...
         * @static 
         */ 
        public static function getNotificationFeed($user_id)
        {
            return \GetStream\StreamLaravel\StreamLaravelManager::getNotificationFeed($user_id);
        }
         ...
         * @static 
         */ 
        public static function getNewsFeeds($user_id)
        {
            return \GetStream\StreamLaravel\StreamLaravelManager::getNewsFeeds($user_id);
        }
         ...
         * @static 
         */ 
        public static function followUser($user_id, $target_user_id)
        {
            return \GetStream\StreamLaravel\StreamLaravelManager::followUser($user_id, $target_user_id);
        }
         ...
         * @static 
         */ 
        public static function unfollowUser($user_id, $target_user_id)
        {
            return \GetStream\StreamLaravel\StreamLaravelManager::unfollowUser($user_id, $target_user_id);
        }
        ...
        {
            return \GetStream\StreamLaravel\StreamLaravelManager::getClient();
        }
         ...
         * @static 
         */ 
        public static function getFeed($feed, $user_id)
        {
            return \GetStream\StreamLaravel\StreamLaravelManager::getFeed($feed, $user_id);
        }
         ...
         * @static 
         */ 
        public static function activityCreated($instance)
        {
            return \GetStream\StreamLaravel\StreamLaravelManager::activityCreated($instance);
        }
         ...
         * @static 
         */ 
        public static function activityDeleted($instance)
        {
            return \GetStream\StreamLaravel\StreamLaravelManager::activityDeleted($instance);
        }
...
namespace  { 
    ...
    class FeedManager extends \GetStream\StreamLaravel\Facades\FeedManager {}
